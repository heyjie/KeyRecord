//DataGridViewAutoFilterColumnHeaderCell.cs
using System;
...
namespace GlobalHook
{
    ...
    public class DataGridViewAutoFilterColumnHeaderCell : DataGridViewColumnHeaderCell
    {
        ...
        /// <summary>
        /// 指示DataGridView当前是否由拥有列过滤。
        /// </summary>
        private Boolean filtered;

        /// <summary>
        /// 初始化DataGridViewColumnHeaderCell类的新实例，
        /// 并将其属性值设置为指定DataGridViewColumnHeaderCell的属性值。
        /// </summary>
        /// <param name="oldHeaderCell">DataGridViewColumnHeaderCell从中复制属性值。</param>
