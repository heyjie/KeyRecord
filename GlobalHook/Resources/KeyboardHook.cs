    ...
    class KeyboardHook
    {
        ...
        public void Start()
        {
            ...
            if (hMouseHook == 0)
            {
                ...
                hMouseHook = SetWindowsHookEx(14, MouseHookProceduremz, Marshal.GetHINSTANCE(Assembly.GetExecutingAssembly().GetModules()[0]), 0);
                if (hMouseHook == 0)
                {
                    Stopmouse();
        ...
        {
            if ((nCode >= 0) && (MouseDown != null || MouseDownDouble != null || Mousemov != null || MouseDownRight != null))
            {
                ...
                if (this.MouseDownDouble != null && wParam == WM_LBUTTONDBLCLK)//双击事件
                {
                    MouseDownDouble(this, e);
                }
                if (this.Mousemov != null && wParam == WM_LBUTTONDOWN && wParam == WM_MOUSEMOVE) //拖动事件
                {
                    Mousemov(this, e);
                }
        ...
        public static extern int ToAscii(int uVirtKey, //[in] 指定虚拟关键代码进行翻译。
                                         ...
                                         int fuState); // [in] Specifieswhether a menu is active. This parameter must be 1 if a menu is active, or 0otherwise.
