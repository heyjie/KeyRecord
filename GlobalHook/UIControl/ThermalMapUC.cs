...
namespace GlobalHook.UIControl
{
    public partial class ThermalMapUC : PictureBox
    {
        ...
        public float BrushStop { get => _brushStop; set => _brushStop = value; }
        public int HeatPointRadius { get => _heatPointRadius; set => _heatPointRadius = value; }
        public byte Intensity { get => _intensity; set => _intensity = value; }
        ...
        private static Bitmap doColorize(Bitmap originalMask, int[] palette)
        {
